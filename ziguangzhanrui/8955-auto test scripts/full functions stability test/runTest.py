...
from gprs._gprs import GprsSuite
...
#MODULES = GprsSuite
MODULES = GeneralSuite + SimStkSuite + PhonebookSuite + AudioSuite + CallSuite + NetworkServiceSuite + GprsSuite
...
output = open(dir + r'\result\rda8955_at_report.html', "wb")
